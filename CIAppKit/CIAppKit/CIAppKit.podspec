#
#  Be sure to run `pod spec lint CIAppKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Collected useful function and format checker which used widely in iOS App development.
  Such like mobile format check, number check, string check, etc...
                   DESC

  s.homepage     = "https://github.com/Mobile-CloudInteractive/iOSCodeBase.git"
  ...
  s.source       = { :git => "https://github.com/Mobile-CloudInteractive/iOSCodeBase.git", :tag => "#{s.version}" }

...
@protocol CILockPatternViewDelegate;

@interface CILockPatternView : UIView <NSCoding>
 ...
 */
@property (nonatomic, weak) IBOutlet id<CILockPatternViewDelegate> delegate;
 ...
 */
@property (nonatomic, copy) void(^didDrawPatternWithPassword)(CILockPatternView *lockView, NSUInteger dotCounts, NSString *password);
...
@protocol CILockPatternViewDelegate <NSObject>
 ...
 */
- (void)patternLockView:(CILockPatternView *)lockView didDrawPatternWithDotCounts:(NSUInteger)dotCounts password:(NSString *)password;
